...
Add-Band $slide 372 438 514 34 'At 5k ants MPI is slower; at 100k ants the best case is 2 processes with about 1.46x speedup.' (RGB-Color 255 244 234) (RGB-Color 254 215 170)
...
Add-BulletPanel $slide 66 126 820 304 'Main conclusions' @(
    ...
    'MPI was correct after the build fix, but its replicated-map design introduced a communication cost that is only amortized at larger workloads.'
)
